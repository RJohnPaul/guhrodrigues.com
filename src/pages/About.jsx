...
const About = ({ title }) => {
  ...
  return (
    <section className="w-full md:min-h-screen p-2 flex items-center py-16">
        ...
        <div className="md:grid lg:grid-cols-5">
          ...
          <div className="col-span-3 flex justify-center flex-col sm:mt-6 lg:ml-24 lg:mt-0 gap-3 sm:px-1 lg:px-0">
            <p className="lg:text-md sm:text-center lg:text-start leading-8 text-gray-400">
              Meu nome é <span className="text-primary">Gustavo Rodrigues</span>
              , tenho <span className="text-primary">17 anos</span> e nasci na
              região do Grande ABC. Sou{" "}
