                    ...
                    <div className="md:grid lg:grid-cols-5">
                        ...
                        <div className="col-span-3 flex justify-center flex-col sm:mt-6 lg:ml-24 lg:mt-0 gap-3 sm:px-1 lg:px-0">
                            <p className="lg:text-md sm:text-center lg:text-start leading-8 text-gray-400">
                                ...
                                , tenho{" "}
                                <span className="text-primary">17 anos</span> e
                                nasci na região do Grande ABC. Sou{" "}
                                <span className="text-primary">
                                    desenvolvedor web
                                </span>{" "}
                                e estudante de{" "}
                            ...
                            <p className="lg:text-md sm:text-center lg:text-start leading-8 text-gray-400">
                                Tive meu{" "}
                                <span className="text-primary">
                                    primeiro contato com desenvolvimento web em
                                    2021
                                </span>
                            ...
                            <p className="lg:text-md sm:text-center lg:text-start leading-8 text-gray-400">
                                ...
                                e assim aprimorar ainda mais as habilidades que
                                possuo.
                            </p>
