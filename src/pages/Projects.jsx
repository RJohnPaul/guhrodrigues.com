            ...
            >
              ...
              <div className="flex items-center gap-1.5 mx-4 my-3 pb-1">
                <a
                  ...
                  target="_blank"
                >
                  <button className="max-w-full flex flex-row items-center justify-center gap-2 text-[14px] bg-primary border-2 border-transparent rounded-lg text-[#D2EAFF] py-2 px-3 duration-300 hover:bg-[#0184fc]">
                    Visitar
                  </button>
                </a>
                <a
                  ...
                  target="_blank"
                >
                  <button className="max-w-full flex flex-row items-center justify-center gap-2 text-[14px] border-2 border-primary rounded-lg hover:bg-primary hover:text-[#D2EAFF] py-2 px-3 duration-300">
                    Repositório
                  </button>
                </a>
              </div>
