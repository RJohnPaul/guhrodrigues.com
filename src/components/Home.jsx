...
const Home = () => {
    return (
        <section
            ...
            id="home"
        >
            <div className="md:col-span-5 lg:ml-12 xl:ml-12 2xl:ml-36 flex items-center justify-center p-8">
                <div className="flex flex-col gap-4 xl:ml-12 2xl:-mr-10">
                    <h1 className="text-white xl:ml-12 2xl:ml-12">
                        <span className="font-medium">Olá! Meu nome é</span><br />
                    ...
                    <div className="xl:ml-12 2xl:ml-12 flex sm:justify-center md:justify-start">
                        <a href="#projects">
                            <button className="relative inline-flex items-center gap-[0.5rem] bg-gradient-to-r from-primary to-secondary text-black 2xl:text-[1.2rem] py-[0.8rem] px-[1.4rem] rounded-[0.8rem] isolate">
                                Portfólio
                                <RiSendPlane2Line />
                            </button>
                        </a>
