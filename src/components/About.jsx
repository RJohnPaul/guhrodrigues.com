...
const About = () => {
    return (
        <section className="w-full md:h-screen p-2 flex items-center py-16" id="about">
            <div className="sm:max-w-[500px] md:max-w-[700px] lg:max-w-[1000px] 2xl:max-w-[1240px] xl:max-w-[1000px] 
            m-auto md:grid grid-cols-3 gap-8 shadow-xl rounded-[45px] bg-backgroundSecondary p-5">
                ...
                <div className="col-span-2">
                    ...
                    <div className="mt-5 flex text-center justify-center">
                        <a href="../../public/assets/docs/curriculo.pdf" download="Gustavo Rodrigues.pdf" target="_blank">
